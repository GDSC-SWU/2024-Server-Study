package com.example.gdg.config.jwt;
...
public class TokenProviderTest {
    ...
    // 1. generatedToken() 검증 테스트
    @DisplayName("generateToken(): 유저 정보와 만료 기간 전달해 토큰 생성 가능함")
    @Test
    void generateToken() {
        // given
    ...
    @DisplayName("validToken(): 유효한 토큰인 때에 유효성 검증에 성공함")
    @Test
    ...
    @DisplayName("getAuthentication(): 토큰 기반으로 인증 정보 가져올 수 있음")
    @Test
